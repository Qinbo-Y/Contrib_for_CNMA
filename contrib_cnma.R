...
solve_system <- function(X, e, tolerance = 1e-4) {
...
cnma_contrib <- function(cnma, component, inactive, random = TRUE, fixed = NULL, kmax = 4) {
  ...
  study_comparisons <- study_comparisons[order(study_comparisons$cnma_comparison,
                                               study_comparisons$studyID), ]
...
#     and their representations in the CNMA model.
